...
public class DeleteCommandSystemTest extends VenueBookSystemTest {
    ...
    public void delete() {
        ...
        /* Case: filtered event list, delete index within bounds of schedule and event list -> deleted */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
        Index index = INDEX_FIRST_EVENT;
        assertTrue(index.getZeroBased() < getModel().getFilteredEventList().size());
        assertCommandSuccess(index);

        /* Case: filtered event list, delete index within bounds of schedule but out of bounds of event list
         * -> rejected
         */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
        ...
        Index outOfBoundsIndex = Index.fromOneBased(
                getModel().getSchedule().getEventList().size() + 1);
    ...
    /**
     * Removes the {@code Event} at the specified {@code index} in {@code model}'s schedule.
     ...
     * {@code VenueBookSystemTest#assertApplicationDisplaysExpected(String, String, Model)}.
