...
public class SelectCommandSystemTest extends VenueBookSystemTest {
    @Test
    public void select() {
        ...
        /* Case: filtered event list, select index within bounds of schedule but out of bounds of event list
         * -> rejected
         */
        ...
        /* Case: filtered event list, select index within bounds of schedule and event list -> selected */
        ...
        /* Case: select from empty schedule -> rejected */
        deleteAllPersons();
