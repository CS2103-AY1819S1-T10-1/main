...
/**
 * A system test class for Schedule, which provides access to handles of GUI components and helper methods
 * for test verification.
 */
public abstract class VenueBookSystemTest {
    @ClassRule
     ...
     */
    protected Schedule getInitialData() {
        return TypicalPersons.getTypicalSchedule();
    }
    ...
    /**
     * Displays all events in the schedule.
     */
    protected void showAllPersons() {
        executeCommand(ListCommand.COMMAND_WORD);
        assertEquals(getModel().getSchedule().getEventList().size(), getModel().getFilteredEventList().size());
    }
    ...
    protected void showPersonsWithName(String keyword) {
        ...
        assertTrue(getModel().getFilteredEventList().size() < getModel().getSchedule().getEventList().size());
    }
    ...
    /**
     * Deletes all events in the schedule.
     */
    protected void deleteAllPersons() {
        executeCommand(ClearCommand.COMMAND_WORD);
        assertEquals(0, getModel().getSchedule().getEventList().size());
    }
    ...
    protected void assertApplicationDisplaysExpected(String expectedCommandInput, String expectedResultMessage,
        ...
        assertEquals(new Schedule(expectedModel.getSchedule()), testApp.readStorageAddressBook());
