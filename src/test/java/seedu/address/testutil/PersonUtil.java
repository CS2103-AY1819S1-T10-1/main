...
public class PersonUtil {
    ...
    public static String getPersonDetails(CalendarEvent calendarEvent) {
        ...
        sb.append(PREFIX_DATETIME + calendarEvent.getDateTime().localDateTime.toString() + " ");
    ...
    public static String getEditPersonDescriptorDetails(EditCommand.EditCalendarEventDescriptor descriptor) {
        ...
        descriptor.getDateTime().ifPresent(dateTime -> sb.append(PREFIX_DATETIME).append(dateTime.localDateTime).append(" "));
