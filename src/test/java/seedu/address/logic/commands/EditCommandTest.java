...
public class EditCommandTest {
    ...
    public void execute_allFieldsSpecifiedUnfilteredList_success() {
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder(editedCalendarEvent).build();
        EditCommand editCommand = new EditCommand(INDEX_FIRST_PERSON, descriptor);

        String expectedMessage = String.format(EditCommand.MESSAGE_EDIT_PERSON_SUCCESS, editedCalendarEvent);
    ...
    public void execute_duplicatePersonUnfilteredList_failure() {
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder(firstCalendarEvent).build();
