...
public class CommandTestUtil {
    ...
    public static final LocalDateTime VALID_DATETIME_AMY = LocalDateTime.of(2018,10,07,18,00);
    public static final LocalDateTime VALID_DATETIME_BOB = LocalDateTime.of(2018,10,13,22,29);
    ...
    public static final String INVALID_DATETIME_DESC = " " + PREFIX_DATETIME +
            LocalDateTime.of(-1,10,14,1,10); // year must > 0
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
            .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withDateTime(VALID_DATETIME_AMY).withAddress(VALID_ADDRESS_AMY)
            .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
            .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withDateTime(VALID_DATETIME_BOB).withAddress(VALID_ADDRESS_BOB)
