...
public class EventListPanelTest extends GuiUnitTest {
    ...
    /**
     * Returns a list of events containing {@code personCount} events that is used to populate the
    ...
    /**
     * Returns a .xml file containing {@code personCount} events. This file will be deleted when the JVM terminates.
     */
