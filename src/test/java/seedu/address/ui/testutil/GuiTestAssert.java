...
public class GuiTestAssert {
    ...
    public static void assertCardDisplaysPerson(Event expectedEvent, PersonCardHandle actualCard) {
        ...
        assertEquals(expectedEvent.getDate().value, actualCard.getPhone());
        assertEquals(expectedEvent.getTime().value, actualCard.getEmail());
        assertEquals(expectedEvent.getVenue().value, actualCard.getAddress());
