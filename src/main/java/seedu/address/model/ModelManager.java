...
public class ModelManager extends ComponentManager implements Model {
    ...
    private final VersionedSchedule versionedAddressBook;
    private final FilteredList<Event> filteredEvents;

    /**
     * Initializes a ModelManager with the given addressBook and userPrefs.
     */
    public ModelManager(ReadOnlySchedule addressBook, UserPrefs userPrefs) {
        super();
        requireAllNonNull(addressBook, userPrefs);

        logger.fine("Initializing with schedule: " + addressBook + " and user prefs " + userPrefs);

        versionedAddressBook = new VersionedSchedule(addressBook);
