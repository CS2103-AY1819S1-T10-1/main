...
public class MainApp extends Application {
    ...
    /**
     * Returns a {@code ModelManager} with the data from {@code storage}'s schedule and {@code userPrefs}. <br>
     * The data from the sample schedule will be used instead if {@code storage}'s schedule is not found,
    ...
    @Override
    public void stop() {
        logger.info("============================ [ Stopping Venue Book ] =============================");
        ui.stop();
        try {
